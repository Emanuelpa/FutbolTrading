    ...
    <div class="col-lg-6 col-md-8 col-sm-10">
      <div class="card bg-dark text-light shadow-lg border-0 mb-4">
        ...
        <div class="card-body p-4">
          ...
          <form action="{{ route('admin.tradeProduct.update', $viewData['tradeProduct']->getId()) }}" method="POST"
            ...
            <div class="mb-3">
              ...
              <select name="type" class="form-control auth-field" required>
                ...
                <option value="{{ $type }}" class="text-white" {{ $type==$viewData['tradeProduct']->getType() ?
                  'selected' : '' }}>
                  {{ $type }}
                </option>
                @endforeach
            ...
            <div class="mb-3">
              ...
              <select name="offerType" class="form-control auth-field" required>
                ...
                <option value="{{ $offerOption }}" class="text-white" {{ $offerOption==$viewData['tradeProduct']->
                  getOfferType() ? 'selected' : '' }}>
                  {{ $offerOption }}
                </option>
                @endforeach
              </select>
            ...
            <div class="mb-3">
              ...
              <select name="user" class="form-control auth-field" required>
                ...
                <option value="{{ $user->getId() }}" class="text-white" {{ $user->getId() ==
                  $viewData['tradeProduct']->getUser()->getId() ? 'selected' : '' }}>
                  {{ $user->getName() }}
                </option>
                @endforeach
              </select>
            ...
            <div class="mb-3">
              ...
              <div class="mb-2">
                <img id="imagePreview" src="{{ asset('storage/' . $viewData['tradeProduct']->getImage()) }}"
            ...
            <div class="row mb-0 mt-5 col-md-20 ">
              <div class="col-md-6 offset-md-4">
                <a href="{{ url()->previous() }}" class="btn btn-secondary"><i class="fa-solid fa-arrow-left me-2"></i>
                  {{ __('Admin.back') }}
                </a>
