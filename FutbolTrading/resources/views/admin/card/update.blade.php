        ...
        <div class="card-body p-4">
          ...
          <form action="{{ route('admin.card.update', $viewData['card']->getId()) }}" method="POST"
            ...
            <div class="mb-3">
              ...
              <input type="text" name="name" class="form-control auth-field" value="{{ $viewData['card']->getName() }}"
                required>
            </div>
            ...
            <div class="mb-3">
              ...
              <div class="mb-2">
                <img id="imagePreview" src="{{ asset('storage/' . $viewData['card']->getImage()) }}" alt="Current Image"
                  class="img-fluid rounded d-block mx-auto w-25">
              </div>
