        ...
        <div class="card-body">
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.card.save') }}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                <label for="description" class="col-md-4 col-form-label text-md-end">{{ __('Admin.description')
                  }}</label>
                <div class="col-md-6">
              ...
              <div class="row mb-3">
                <label for="offerDescription" class="col-md-4 col-form-label text-md-end">{{ __('Admin.price')
                  }}</label>
