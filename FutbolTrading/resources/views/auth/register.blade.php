    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card bg-dark">
                <div class="card-header fs-4">{{ __('Auth.register') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="phone"
                                class="col-md-4 col-form-label text-md-end">{{ __('Auth.phone_number') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text"
                                    class="form-control auth-field @error('city') is-invalid @enderror" name="city"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="address" type="text"
                                    class="form-control auth-field @error('address') is-invalid @enderror"
                        ...
                        <div class="row mb-0 mt-5 col-md-20">
                            <div class="col-md-6 offset-md-4">
                                <a href="{{ url()->previous() }}"
                                    class="btn btn-secondary me-2 active">{{ __('Home.back') }}</a>
