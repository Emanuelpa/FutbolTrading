      ...
      <div class="col-md-8">
        <div class="card bg-dark">
          ...
          <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{ route('tradeProduct.save') }}" enctype="multipart/form-data">
              @csrf
              ...
              <div class="row mb-3">
                <label for="image" class="col-md-4 col-form-label text-md-end">{{ __('TradeProduct.image') }}</label>
