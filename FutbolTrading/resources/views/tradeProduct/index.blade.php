          ...
          <div class="col-md-4">
            <div class="card mb-4 bg-dark text-white">
              ...
              <div class="card-body bg-dark">
                ...
                <p class="card-text"><small>{{ __('TradeProduct.published_on') }}
